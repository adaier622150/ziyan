...
/**
 * @author yibin.zou Date: 2019/8/12 Time: 7:49 PM
 */
public class CommonConstants {
    ...
    public static final String X_REAL_WORMPEX_HOSTNAME = "X-Real-ade-HostName";

    public static final String X_REAL_WORMPEX_IP = "X-Real-ade-IP";
